...
import Page1 from "../../assets/PIEP1.jpg";
import Page2 from "../../assets/PIEP2.jpg";
        ...
        <div className="parent">
            <div className='port__containerb containerb'>
                <article className='port_itemb'>
                    ...
                    <a className='buy_button' href = 'https://a.co/d/6BqcoOp'>Purchase On Amazon</a>
                </article>
                <article>
                    <div className="port-item-content"> {/* You might need an additional container for content */}
                        <h2>Panic in Ecuador</h2>
                        <p className='book-sub'>BOOK 2 IN THE MIRANDA'S TRAVEL ADVENTURE'S SERIES</p>
                        <p className='para'>
